...
// tur bazlı haber akışı (excel yok, direkt koda gömülü)
...
KTM (STK4) bu ay yurtdışında 10 yeni mağaza açılışı gerçekleştirdi.`
  ...
  {
    tur: 3,
    haber: `Döviz kurlarındaki artış devam ediyor. 
Enerjideki fiyat artışı sanayi ve perakende sektöründe operasyonel maliyet artışı sebebiyle endişe yarattı.`
  },
  {
    tur: 4,
